...
module.exports = async function({ plants, nurseries }) {
  ...
  app.get('/api/v1/plants', async (req, res) => {
    try {
      ...
      let maxHeight = (heightsOfTallest && heightsOfTallest[heightsOfTallest.length - 1]) || 0;
      const heights = [];
  ...
  app.get('/api/v1/nurseries', async (req, res) => {
    try {
      const results = await nurseries.find().sort({ Name: 1 }).toArray();
      return res.send({
        results
      });
    } catch (e) {
  ...
  app.get('*', async (req, res) => {
    ...
    <html lang="en">
      <head>
        ...
        <link rel="icon" href="/assets/images/logo-transparent-square-32x32.png" sizes="32x32" />
        <link rel="icon" href="/assets/images/logo-transparent-square-192x192.png" sizes="192x192" />
        <link rel="apple-touch-icon" href="/assets/images/logo-transparent-square-192x192.png" />
        <meta name="msapplication-TileImage" content="/assets/images/logo-transparent-square-192x192.png" />
        <meta property="og:title" content="Choose Native Plants PA">
        <meta property="og:description" content="Find out which native shrubs, plants and flowers from Pennsylvania have the right conditions to flourish in your garden.">
        ...
        <meta property="twitter:description" content="Find out which native shrubs, plants and flowers from Pennsylvania have the right conditions to flourish in your garden.">
