...
module.exports = async () => {
  ...
  const nurseryOfferings = db.collection('nursery_offerings');
  const zipCodeGeographies = db.collection('zip_code_geographies');
  const syncState = db.collection('plantagents_sync_state');
